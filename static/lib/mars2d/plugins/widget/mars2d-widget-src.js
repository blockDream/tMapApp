 ...
 * 版本信息：v3.0.3, hash值: 13a5b6de1a24f08afbbd
 * 编译日期：2022-01-15 17:37:49
 * 版权所有：Copyright by 火星科技 http://mars2d.cn
 *
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("mars2d"));
	else if(typeof define === 'function' && define.amd)
		define("mars2dWidget", ["mars2d"], factory);
	else if(typeof exports === 'object')
		exports["mars2dWidget"] = factory(require("mars2d"));
	else
		root["mars2dWidget"] = factory(root["mars2d"]);
...
// EXTERNAL MODULE: external "mars2d"
var external_mars2d_ = __webpack_require__(0);

// EXTERNAL MODULE: ./src/theme/widget.scss
var widget = __webpack_require__(8);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/typeof.js
var helpers_typeof = __webpack_require__(1);
var typeof_default = /*#__PURE__*/__webpack_require__.n(helpers_typeof);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/defineProperty.js
...
// CONCATENATED MODULE: ./src/widget/WidgetEventType.js
/**
...
function init(map) {
  ...
  thismap = map;
  widgetsdata = [];
  defoptions = external_mars2d_["Util"].merge({
    windowOptions: {
      position: "rt",
      maxmin: false,
      resize: true
  ...
  if (arrtemp && arrtemp.length > 0) {
    for (var i = 0; i < arrtemp.length; i++) {
      ...
      item._nodebug = true;
      bindDefOptions(item);
      item._firstConfigBak = _objectSpread({}, item);
    ...
    for (var _i = 0; _i < arrtemp.length; _i++) {
      ...
      if (_item.type == "group") {
        ...
        for (var j = 0; j < _item.children.length; j++) {
          ...
          childItem._firstConfigBak = _objectSpread({}, childItem);
        ...
        _item._firstConfigBak = _objectSpread({}, _item);
...
function getDefWindowOptions() {
  return external_mars2d_["Util"].clone(defoptions.windowOptions, removeKeys);
}
...
function disable(uri) {
  ...
  if (Array.isArray(uri)) {
    ...
    for (var i = 0; i < widgetsdata.length; i++) {
      ...
      for (var j = 0; j < arrUri.length; j++) {
        var _uri2 = arrUri[j];

        if (item._class && (_uri2 == item.uri || _uri2 == item.id)) {
    ...
    if (typeof_default()(uri) === "object") {
      uri = uri.uri;
    }

    for (var _i5 = 0; _i5 < widgetsdata.length; _i5++) {
      var _item4 = widgetsdata[_i5];

      if (_item4._class && (uri == _item4.uri || uri == _item4.id)) {
        _item4._class.disableBase();
...
var eventTarget = new external_mars2d_["BaseClass"]();
/**
 * 绑定指定类型事件监听器
 *
...
// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/classCallCheck.js
var classCallCheck = __webpack_require__(4);
var classCallCheck_default = /*#__PURE__*/__webpack_require__.n(classCallCheck);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/createClass.js
var createClass = __webpack_require__(5);
var createClass_default = /*#__PURE__*/__webpack_require__.n(createClass);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/inherits.js
var inherits = __webpack_require__(6);
var inherits_default = /*#__PURE__*/__webpack_require__.n(inherits);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/possibleConstructorReturn.js
var possibleConstructorReturn = __webpack_require__(7);
var possibleConstructorReturn_default = /*#__PURE__*/__webpack_require__.n(possibleConstructorReturn);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.16.5@@babel/runtime/helpers/getPrototypeOf.js
...
function BaseWidget_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function BaseWidget_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? BaseWidget_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : BaseWidget_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
var BaseClass = external_mars2d_["BaseClass"];
...
var BaseWidget_BaseWidget = /*#__PURE__*/function (_BaseClass) {
  ...
  createClass_default()(BaseWidget, [{
    ...
    value: function _openWindow(viewopt) {
      ...
      var opts = {
        ...
        success: function success(layero, index) {
          ...
          var viewWindow = window[layero.find("iframe")[0]["name"]]; //绑定常用对象到子页面，方便直接使用

          viewWindow.map = _this2.map;
          viewWindow.mars2d = external_mars2d_;
          viewWindow.L = external_mars2d_["L"]; //设置css
          ...
          if (viewWindow && viewWindow.initWidgetView) {
            ...
            external_mars2d_["Log"].logError(view_url + "页面没有定义function initWidgetView(widget)方法，无法初始化widget页面!");
          }
        }
      };
    ...
    value: function _getWinOpt(viewopt, opts) {
      ...
      var windowOptions = BaseWidget_objectSpread(BaseWidget_objectSpread(BaseWidget_objectSpread({}, def), viewopt.windowOptions), this.options.windowOptions);
      ...
      return BaseWidget_objectSpread(BaseWidget_objectSpread(BaseWidget_objectSpread({}, defOpts), windowOptions), opts);
    } //计算弹窗大小和位置
    ...
    key: "minView",
    value: function minView() {
      this.eachView(function (viewopt) {
        if (viewopt._layerIdx) {
          BaseWidget_layer.min(viewopt._layerIdx, viewopt);
        }
      });
    }
    /**
    ...
    value: function restoreView() {
      this.eachView(function (viewopt) {
        if (viewopt._layerIdx) {
          BaseWidget_layer.restore(viewopt._layerIdx);
        }
      });
    }
    /**
    ...
    key: "fullView",
    value: function fullView() {
      this.eachView(function (viewopt) {
        if (viewopt._layerIdx) {
          BaseWidget_layer.full(viewopt._layerIdx, viewopt);
        }
      });
    }
    /**
    ...
    key: "setTitle",
    value: function setTitle(title, index) {
      this.eachView(function (viewopt) {
        if (viewopt._dom) {
...
external_mars2d_["widget"] = widgetManager_namespaceObject;

external_mars2d_["widget"].BaseWidget = BaseWidget_BaseWidget;

external_mars2d_["widget"].WidgetEventType = WidgetEventType;
external_mars2d_["widget"].EventType = WidgetEventType;


/***/ })
/******/ ]);
});
//# sourceMappingURL=mars2d-widget-src.js.map
