  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        c: common_vendor.sr("item1", "620416cc-1,620416cc-0"),
        d: common_vendor.p({
          label: "地点编码",
          prop: "userInfo.name",
          borderBottom: true
        ...
        g: common_vendor.sr("item1", "620416cc-3,620416cc-0"),
        h: common_vendor.p({
          label: "所在位置",
          prop: "userInfo.area",
          borderBottom: true
        ...
        k: common_vendor.sr("item1", "620416cc-5,620416cc-0"),
        l: common_vendor.p({
          label: "详细地址",
          prop: "userInfo.area",
          borderBottom: true
        ...
        o: common_vendor.sr("item1", "620416cc-7,620416cc-0"),
        p: common_vendor.p({
          label: "地名类别",
          prop: "userInfo.area",
          borderBottom: true
        ...
        s: common_vendor.sr("item1", "620416cc-9,620416cc-0"),
        t: common_vendor.p({
          label: "普查状态",
          prop: "userInfo.area",
          borderBottom: true
        ...
        x: common_vendor.sr("item1", "620416cc-11,620416cc-0"),
        y: common_vendor.p({
          label: "使用时间",
          prop: "userInfo.area",
          borderBottom: true
        ...
        B: common_vendor.sr("item1", "620416cc-13,620416cc-0"),
        C: common_vendor.p({
          label: "标准名称",
          prop: "userInfo.area",
          borderBottom: true
        ...
        F: common_vendor.sr("item1", "620416cc-15,620416cc-0"),
        G: common_vendor.p({
          label: "原图名称",
          prop: "userInfo.area",
          borderBottom: true
        ...
        J: common_vendor.sr("item1", "620416cc-17,620416cc-0"),
        K: common_vendor.p({
          label: "罗马字数拼写",
          prop: "userInfo.area",
          borderBottom: true
        ...
        O: common_vendor.sr("item1", "620416cc-19,620416cc-0"),
        P: common_vendor.p({
          label: "现场拍照(提供照片,截图审核更快)",
          prop: "userInfo.area",
          borderBottom: true
        }),
        Q: common_vendor.sr(form1, "620416cc-0", {
          "k": "form1"
        }),
        R: common_vendor.p({
          labelPosition: "left",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-620416cc"], ["__file", "D:/map/map/pages/index/cpns/layer-panel/cpns/surveyor/cpns/place/place.vue"]]);
