...
if (!Math) {
  ...
  "./pages/mapList/cpns/leftletMap/leftletMap.js";
  "./pages/myHome/myHome.js";
  "./pages/index/cpns/layer-panel/cpns/standard-map/index.js";
  "./pages/index/cpns/layer-panel/cpns/theme-layer/index.js";
  "./pages/index/cpns/layer-panel/cpns/atlas/atlas.js";
  "./pages/index/cpns/layer-panel/cpns/spacetimePhoto/spacetimePhoto.js";
  "./pages/index/cpns/layer-panel/cpns/surveyor/surveyor.js";
  "./pages/index/cpns/layer-panel/cpns/surveyor/cpns/place/place.js";
  "./pages/index/cpns/layer-panel/cpns/surveyor/cpns/address/address.js";
  "./pages/index/cpns/layer-panel/cpns/surveyor/cpns/antique/antique.js";
  "./pages/index/cpns/layer-panel/cpns/surveyor/cpns/tourism/tourism.js";
}
const _sfc_main = {
  onLaunch: function() {
...
const App = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/map/map/App.vue"]]);
function createApp() {
  const app = common_vendor.createSSRApp(App);
  app.config.globalProperties.$api = api_api.api;
  app.config.globalProperties.$rootUrl = api_api.rootUrl;
  app.config.globalProperties.$http = api_http.https;
